...
class DQLearner:
    ...
    def learn(self, env):
        self.env = env
        ep = 0
        sum_sum_reward, sum_avg_loss, max_sum_reward, max_avg_sum_reward = 0, 0, -1, -1
        ...
        while(True):
            ...
            ep += 1
            sum_reward, sum_loss, n_loss = 0, 0, 0
            ...
            if ep % self.args.print_ep_period == 0:
                ...
                print('episode : ', ep, ', avg_rew :', avg_sum_reward, ', avg_loss :', sum_avg_loss / self.args.print_ep_period)
